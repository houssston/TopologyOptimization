...
def Macro1():
    ...
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.32/Model.IGS', msbo=False, trimCurve=DEFAULT, scaleFromFile=OFF)
    ...
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.32/Lower.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.32/LowerPlate.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.32/Tool.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.32/Upper.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.32/UpperPlate.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['LowerPlate']
    p.ReferencePoint(point=(0.0, 19.4337, 10))
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['UpperPlate']
    p.ReferencePoint(point=(0.0, 59.8787, 10))
    ...
    mdb.models['Model-1'].boundaryConditions['Load-LoerPlate'].setValuesInStep(
        stepName='Step-4', u2=195.326)
    mdb.saveAs(pathName='D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.32/cae')
