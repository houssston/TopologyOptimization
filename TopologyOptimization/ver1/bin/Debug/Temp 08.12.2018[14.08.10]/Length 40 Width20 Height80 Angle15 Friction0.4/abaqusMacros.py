...
def Macro1():
    ...
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.4/Model.IGS', msbo=False, trimCurve=DEFAULT, scaleFromFile=OFF)
    ...
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.4/Lower.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.4/LowerPlate.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.4/Tool.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.4/Upper.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.4/UpperPlate.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['LowerPlate']
    p.ReferencePoint(point=(0.0, 19.5313, 10))
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['UpperPlate']
    p.ReferencePoint(point=(0.0, 59.5309, 10))
    ...
    mdb.models['Model-1'].boundaryConditions['Load-LoerPlate'].setValuesInStep(
        stepName='Step-4', u2=193.374)
    mdb.saveAs(pathName='D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 08.12.2018[14.08.10]/Length 40 Width20 Height80 Angle15 Friction0.4/cae')
