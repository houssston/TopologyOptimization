...
def Macro1():
    ...
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 11.12.2018[20.04.02]/Length 40 Width20 Height80 Angle30 Friction0.36/Model.IGS', msbo=False, trimCurve=DEFAULT, scaleFromFile=OFF)
    ...
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 11.12.2018[20.04.02]/Length 40 Width20 Height80 Angle30 Friction0.36/Lower.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 11.12.2018[20.04.02]/Length 40 Width20 Height80 Angle30 Friction0.36/LowerPlate.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 11.12.2018[20.04.02]/Length 40 Width20 Height80 Angle30 Friction0.36/Tool.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 11.12.2018[20.04.02]/Length 40 Width20 Height80 Angle30 Friction0.36/Upper.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 11.12.2018[20.04.02]/Length 40 Width20 Height80 Angle30 Friction0.36/UpperPlate.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['LowerPlate']
    p.ReferencePoint(point=(0.0, 13.9434, 10))
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['UpperPlate']
    p.ReferencePoint(point=(0.0, 64.1466, 10))
    ...
    mdb.models['Model-1'].boundaryConditions['Load-LoerPlate'].setValuesInStep(
        stepName='Step-4', u2=305.132)
    mdb.saveAs(pathName='D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 11.12.2018[20.04.02]/Length 40 Width20 Height80 Angle30 Friction0.36/cae')
