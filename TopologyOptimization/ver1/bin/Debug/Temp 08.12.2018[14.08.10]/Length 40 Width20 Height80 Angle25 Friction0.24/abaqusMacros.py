...
def Macro1():
    ...
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 10.12.2018[20.50.28]/Length 40 Width20 Height80 Angle25 Friction0.24/Model.IGS', msbo=False, trimCurve=DEFAULT, scaleFromFile=OFF)
    ...
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 10.12.2018[20.50.28]/Length 40 Width20 Height80 Angle25 Friction0.24/Lower.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 10.12.2018[20.50.28]/Length 40 Width20 Height80 Angle25 Friction0.24/LowerPlate.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 10.12.2018[20.50.28]/Length 40 Width20 Height80 Angle25 Friction0.24/Tool.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 10.12.2018[20.50.28]/Length 40 Width20 Height80 Angle25 Friction0.24/Upper.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 10.12.2018[20.50.28]/Length 40 Width20 Height80 Angle25 Friction0.24/UpperPlate.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['LowerPlate']
    p.ReferencePoint(point=(0.0, 14.5466, 10))
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['UpperPlate']
    p.ReferencePoint(point=(0.0, 64.3013, 10))
    ...
    mdb.models['Model-1'].boundaryConditions['Load-LoerPlate'].setValuesInStep(
        stepName='Step-4', u2=293.068)
    mdb.saveAs(pathName='D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 10.12.2018[20.50.28]/Length 40 Width20 Height80 Angle25 Friction0.24/cae')
