...
def Macro1():
    ...
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 09.12.2018[13.35.53]/Length 40 Width20 Height80 Angle20 Friction0.2/Model.IGS', msbo=False, trimCurve=DEFAULT, scaleFromFile=OFF)
    ...
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 09.12.2018[13.35.53]/Length 40 Width20 Height80 Angle20 Friction0.2/Lower.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 09.12.2018[13.35.53]/Length 40 Width20 Height80 Angle20 Friction0.2/LowerPlate.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 09.12.2018[13.35.53]/Length 40 Width20 Height80 Angle20 Friction0.2/Tool.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 09.12.2018[13.35.53]/Length 40 Width20 Height80 Angle20 Friction0.2/Upper.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 09.12.2018[13.35.53]/Length 40 Width20 Height80 Angle20 Friction0.2/UpperPlate.IGS', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['LowerPlate']
    p.ReferencePoint(point=(0.0, 16.7752, 10))
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['UpperPlate']
    p.ReferencePoint(point=(0.0, 62.223, 10))
    ...
    mdb.models['Model-1'].boundaryConditions['Load-LoerPlate'].setValuesInStep(
        stepName='Step-4', u2=248.496)
    mdb.saveAs(pathName='D:/MyProject(31.11.18)/ver1/bin/Debug/Temp 09.12.2018[13.35.53]/Length 40 Width20 Height80 Angle20 Friction0.2/cae')
