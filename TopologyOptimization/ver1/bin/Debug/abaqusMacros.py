...
def Macro1():
    ...
    iges = mdb.openIges('@PathModel', msbo=False, trimCurve=DEFAULT, scaleFromFile=OFF)
    ...
    iges = mdb.openIges('@PathLower', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('@PathPlateLower', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('@PathTool', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('@PathUpper', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    iges = mdb.openIges('@PathPlateUpper', msbo=False, trimCurve=DEFAULT, topology=SHELL, scaleFromFile=OFF)
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['Lower']
    p.ReferencePoint(point=(0.0, 0.0, @RPwidth))
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['LowerPlate']
    p.ReferencePoint(point=(0.0, @LowerPlateRP, @RPwidth))
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['Tool']
    p.ReferencePoint(point=(0.0, @RPheight, @Width))
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['Upper']
    p.ReferencePoint(point=(0.0, @Height, @RPwidth))
    ...
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['UpperPlate']
    p.ReferencePoint(point=(0.0, @UpperPlateRP, @RPwidth))
    ...
    mdb.models['Model-1'].materials['Titan'].Density(table=((@MassDensity, ), ))
    mdb.models['Model-1'].materials['Titan'].Elastic(table=((@YoungsModulus, @PoissonsRatio), ))
    mdb.models['Model-1'].materials['Titan'].Plastic(table=(@Material))
    ...
    session.viewports['Viewport: 1'].partDisplay.meshOptions.setValues(
        meshTechnique=ON)
    p = mdb.models['Model-1'].parts['Model']
    p.seedPart(size=@Grid1, deviationFactor=0.1, minSizeFactor=0.1)
    p = mdb.models['Model-1'].parts['Model']
    p.generateMesh()
    p = mdb.models['Model-1'].parts['Lower']
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p = mdb.models['Model-1'].parts['Lower']
    p.seedPart(size=@Grid2, deviationFactor=0.1, minSizeFactor=0.1)
    p = mdb.models['Model-1'].parts['Lower']
    p.generateMesh()
    p = mdb.models['Model-1'].parts['LowerPlate']
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    ...
    mdb.models['Model-1'].DisplacementBC(name='Load-Upper', 
        createStepName='Step-1', region=region, u1=UNSET, u2=-@Moving, u3=UNSET, 
    ...
    mdb.models['Model-1'].boundaryConditions['Load-UpperPlate'].setValuesInStep(
        stepName='Step-3', u2=-@PlateMovingUpper)
    session.viewports['Viewport: 1'].assemblyDisplay.setValues(step='Step-4')
    mdb.models['Model-1'].boundaryConditions['Load-UpperPlate'].setValuesInStep(
    ...
    mdb.models['Model-1'].boundaryConditions['Load-LoerPlate'].setValuesInStep(
        stepName='Step-4', u2=@PlateMovingLower)
    mdb.saveAs(pathName='@PathSaveCAE')
